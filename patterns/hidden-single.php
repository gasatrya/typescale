...
<main class="wp-block-group alignfull"
	...
	<div class="wp-block-group"
		...
		<div class="wp-block-group" style="padding-top:0;padding-bottom:0"><!-- wp:post-title {"level":1} /-->
			...
			<div
				...
				<p>
					<?php echo __( '[read time]', 'typescale' ); ?>
				</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
	...
	<div class="wp-block-group alignfull">
		...
		<div class="wp-block-group">
			<!-- wp:post-terms {"term":"post_tag","separator":"  ","className":"is-style-pill is-style-typescale-post-terms","fontSize":"x-small"} /-->

			<!-- wp:pattern {"slug":"typescale/hidden-single-sharing-row"} /-->
	...
	<!-- wp:pattern {"slug":"typescale/hidden-comments"} /-->
	...
	<div class="wp-block-group">
		...
		<nav aria-label="Posts" class="wp-block-group">
			<!-- wp:post-navigation-link {"type":"previous","label":"<?php esc_html_e( 'Previous:', 'typescale' ); ?> ","showTitle":true,"arrow":"arrow","style":{"layout":{"selfStretch":"fill","flexSize":null}}} /-->

			<!-- wp:post-navigation-link {"textAlign":"right","label":"<?php esc_html_e( 'Next:', 'typescale' ); ?> ","showTitle":true,"arrow":"arrow","style":{"layout":{"selfStretch":"fill","flexSize":null}}} /-->
		</nav>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
