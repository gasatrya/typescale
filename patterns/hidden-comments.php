...
/**
 * Title: Comments
 * Slug: typescale/hidden-comments
 * Inserter: no
 */
?>
				...
				<div class="wp-block-columns is-not-stacked-on-mobile"
					...
					<div class="wp-block-column">
						...
						<div class="wp-block-group hide-empty">
							<!-- wp:comment-reply-link {"className":"is-style-typescale-comment-reply-link"} /-->

							<!-- wp:comment-edit-link {"className":"is-style-typescale-comment-edit-link"} /-->
						</div>
						<!-- /wp:group -->
