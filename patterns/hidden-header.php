	...
	<div class="wp-block-columns is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-stretch">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Blog', 'typescale' ); ?>","url":"#"} /-->
				<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Profile', 'typescale' ); ?>","url":"#"} /-->
				<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Newsletter', 'typescale' ); ?>","url":"#"} /-->
