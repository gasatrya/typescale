...
<div class="wp-block-group">
	...
	<div class="wp-block-group"
		...
		<div class="wp-block-columns"><!-- wp:column {"width":"30%"} -->
			<div class="wp-block-column" style="flex-basis:30%"><!-- wp:heading {"fontSize":"small"} -->
				<h2 class="wp-block-heading has-small-font-size">
					<?php esc_html_e( 'About', 'typescale' ); ?>
				</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column">
				<!-- wp:paragraph -->
				<p>
					<?php esc_html_e( 'I’m Joseph Typescale, a Hungarian-American newspaper publisher. Known for revolutionizing journalism, I left a lasting mark in the form of the Typescale Prize.', 'typescale' ); ?>
				</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph -->
				<p>
					<?php _e( '<a href="#"><em>Read more...</em></a>', 'typescale' ); ?>
				</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		 ...
		 */
		if ( typescale_is_block_registered( 'jetpack/subscriptions' ) ) :
			?>
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column" style="flex-basis:30%">
					...
					<h2 class="wp-block-heading has-small-font-size">
						<?php esc_html_e( 'Newsletter', 'typescale' ); ?>
					</h2>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:column -->
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:30%">
				<!-- wp:heading {"fontSize":"small"} -->
				<h2 class="wp-block-heading has-small-font-size">
					<?php esc_html_e( 'Follow Me', 'typescale' ); ?>
				</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
	...
	<div class="wp-block-group has-contrast-2-color has-text-color has-link-color has-system-sans-serif-font-family has-x-small-font-size" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"typescale/copyright-year"}}}} -->
			<p><?php esc_html_e( '© [year]', 'typescale' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<!-- wp:paragraph -->
		<p>
			<?php _e( 'Theme by <a href="https://andersnoren.se">Anders Norén</a>', 'typescale' ); ?>
		</p>
		<!-- /wp:paragraph -->
