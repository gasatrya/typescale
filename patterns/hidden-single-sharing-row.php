 ...
 * Slug: typescale/hidden-single-sharing-row
 * Categories: hidden
 * Inserter: no
 */
 ...
 */
if ( typescale_is_block_registered( 'jetpack/like' ) || typescale_is_block_registered( 'jetpack/sharing-buttons' ) ) :
	?>
	<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between","verticalAlignment":"top"}} -->
	<div class="wp-block-group">

		<?php if ( typescale_is_block_registered( 'jetpack/like' ) ) : ?>
		...
		<?php if ( typescale_is_block_registered( 'jetpack/sharing-buttons' ) ) : ?>
