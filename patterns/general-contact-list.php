...
/**
 * Title: Contact list
 * Slug: typescale/general-contact-list
 * Categories: typescale
 * Viewport width: 800
 */

$typescale_contact_methods = array(
	array(
		'label' => esc_html_x( 'Email', 'Contact pattern placeholder content', 'typescale' ),
		'value' => 'johnny@domain.com',
		'url'   => 'mailto:',
	),
	array(
		'label' => esc_html_x( 'Phone', 'Contact pattern placeholder content', 'typescale' ),
		'value' => '+1 (201) 555-55 55',
		'url'   => 'tel:',
	),
	array(
		'label' => esc_html_x( 'Twitter/X', 'Contact pattern placeholder content', 'typescale' ),
		'value' => '@johnny_appleseed',
		'url'   => 'https://twitter.com/',
	),
	array(
		'label' => esc_html_x( 'LinkedIn', 'Contact pattern placeholder content', 'typescale' ),
		'value' => '@johnny_appleseed',
		'url'   => 'https://linkedin.com/',
	),
	array(
		'label' => esc_html_x( 'Instagram', 'Contact pattern placeholder content', 'typescale' ),
		'value' => '@johnny_appleseed',
...
<div class="wp-block-group has-system-sans-serif-font-family has-small-font-size" style="margin-top:var(--wp--preset--spacing--80);margin-bottom:var(--wp--preset--spacing--80)">
	<?php
	foreach ( $typescale_contact_methods as $contact_method ) :
		?>
